...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // TO DO 9: Initialize the TextView variable
        ...
        //mSensorManagerStep = (SensorManager) getActivity().getSystemService(Context.SENSOR_SERVICE);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    // TO DO 3: Check if the Accelerometer sensor exists
                    if(mSensorACC != null){
                    ...
                    // TO DO 4: Unregister the listener
...
class StepCounterListener implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            // TO DO 5: Get the sensor type
            case Sensor.TYPE_LINEAR_ACCELERATION:

            // TO DO 6: Get sensor's values
                float x = event.values[0];
                float y = event.values[1];
                float z = event.values[2];

            //////////////////////////// -- PRINT ACC VALUES -- ////////////////////////////////////
            // TO DO 7: Uncomment the following code
            ...
            // TO DO 8: Compute the ACC magnitude
